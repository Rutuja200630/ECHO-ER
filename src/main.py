...
def run_phase(phase: str, data_dir: str, output_dir: str, start_row: int = None, end_row: int = None):
    ...
    if phase == "audit":
        ...
        res_name = batch_retrieve(df_s1, retriever_name, 'entity_id', 'name_view', 'name_view', k=50, batch_size=100, corpus_chunk_size=1000000)
        ...
        res_addr = batch_retrieve(df_s1, retriever_addr, 'entity_id', 'address_view', 'address_view', k=50, batch_size=100, corpus_chunk_size=1000000)
